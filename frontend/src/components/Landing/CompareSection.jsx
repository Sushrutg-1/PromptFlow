  ...
  return (
    <section className="w-full flex items-center justify-center p-4 text-center my-10 ">
      <div id="product" className="gap-5 flex-1 flex-col my-10 justify-center text-center">
        <p className="opacity-70 mb-5">Works with the models you already use</p>
        ...
        <div className="flex flex-col gap-6 my-10">
          ...
          <div className="flex justify-around my-5">
            <div className="relative z-10 bg-zinc-800 p-6 h-full w-[30%]  rounded-[10px] flex flex-col items-center justify-center text-center">
        ...
        <div id="compare" className="flex flex-col items-center gap-8 p-8">
